...
function sendQuestion(userProfile, nextQid, questionFlow, userResponse) {
  var recipientID = userProfile.userID;
  function _sendQuestion(q) {
    var question = questionFlow.findQuestionWithQid(q);
    if (question) {
      var _questionHandlerMap$q = _questionHandlers.questionHandlerMap[question.type](recipientID, question, userProfile, questionFlow, userResponse),
